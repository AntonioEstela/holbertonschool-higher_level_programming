...
## License
<a href="images/mysql-icon.png"><img src="/images/mysql-icon.png" align="middle"></a> SQL - Introduction is open source and therefore free to download and use without permission.
